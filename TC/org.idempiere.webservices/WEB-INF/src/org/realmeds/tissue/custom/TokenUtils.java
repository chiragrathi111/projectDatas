...
public class TokenUtils {
	...
	public static final String REST_REFRESH_TOKEN_EXPIRE_IN_MINUTES = "REST_REFRESH_TOKEN_EXPIRE_IN_MINUTES";
	...
	public static Timestamp getRefreshTokenExpiresAt() {
		Timestamp expiresAt = new Timestamp(System.currentTimeMillis());
		int expMinutes = MSysConfig.getIntValue(REST_REFRESH_TOKEN_EXPIRE_IN_MINUTES, 7500, Env.getAD_Client_ID(Env.getCtx()));
		expiresAt = TimeUtil.addMinutess(expiresAt, expMinutes);
		return expiresAt;
	}
