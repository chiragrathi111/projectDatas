...
/** Generated Model for TC_CultureOperationDetails
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="TC_CultureOperationDetails")
public class X_TC_CultureOperationDetails extends PO implements I_TC_CultureOperationDetails, I_Persistent 
{
    ...
    public X_TC_CultureOperationDetails (Properties ctx, int TC_CultureOperationDetails_ID, String trxName)
    {
      super (ctx, TC_CultureOperationDetails_ID, trxName);
      /** if (TC_CultureOperationDetails_ID == 0)
        {
			setIsDefault (false);
			setName (null);
			setTC_CultureOperationDetails_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_TC_CultureOperationDetails (Properties ctx, int TC_CultureOperationDetails_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, TC_CultureOperationDetails_ID, trxName, virtualColumns);
      /** if (TC_CultureOperationDetails_ID == 0)
        {
			setIsDefault (false);
			setName (null);
    ...
    /** Load Constructor */
    public X_TC_CultureOperationDetails (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_TC_CultureOperationDetails[")
