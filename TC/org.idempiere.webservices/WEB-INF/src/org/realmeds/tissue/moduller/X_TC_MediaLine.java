...
/** Generated Model for TC_MediaLine
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="TC_MediaLine")
public class X_TC_MediaLine extends PO implements I_TC_MediaLine, I_Persistent 
{
    ...
    public X_TC_MediaLine (Properties ctx, int TC_MediaLine_ID, String trxName)
    {
      super (ctx, TC_MediaLine_ID, trxName);
      /** if (TC_MediaLine_ID == 0)
        {
			setLine (0);
			setM_Locator_ID (0);
// @M_Locator_ID@
			setM_Product_ID (0);
			setTC_MediaLine_ID (0);
			setTC_mediaorder_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_TC_MediaLine (Properties ctx, int TC_MediaLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, TC_MediaLine_ID, trxName, virtualColumns);
      /** if (TC_MediaLine_ID == 0)
        {
			setLine (0);
			setM_Locator_ID (0);
// @M_Locator_ID@
    ...
    /** Load Constructor */
    public X_TC_MediaLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_TC_MediaLine[")
	...
	*/
	...
	public org.realmeds.tissue.moduller.I_TC_MediaOrder getTC_mediaorder() throws RuntimeException
	{
		return (org.realmeds.tissue.moduller.I_TC_MediaOrder)MTable.get(getCtx(), org.realmeds.tissue.moduller.I_TC_MediaOrder.Table_ID)
			.getPO(getTC_mediaorder_ID(), get_TrxName());
	}
