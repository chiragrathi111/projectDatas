...
/** Generated Model for TC_MediaOutLine
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="TC_MediaOutLine")
public class X_TC_MediaOutLine extends PO implements I_TC_MediaOutLine, I_Persistent 
{
    ...
    public X_TC_MediaOutLine (Properties ctx, int TC_MediaOutLine_ID, String trxName)
    {
      super (ctx, TC_MediaOutLine_ID, trxName);
      /** if (TC_MediaOutLine_ID == 0)
        {
			setTC_MediaOutLine_ID (0);
			setTC_order_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_TC_MediaOutLine (Properties ctx, int TC_MediaOutLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, TC_MediaOutLine_ID, trxName, virtualColumns);
      /** if (TC_MediaOutLine_ID == 0)
        {
			setTC_MediaOutLine_ID (0);
			setTC_order_ID (0);
    ...
    /** Load Constructor */
    public X_TC_MediaOutLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_TC_MediaOutLine[")
	...
	*/
	...
	{
		return (org.realmeds.tissue.moduller.I_TC_MediaLine)MTable.get(getCtx(), org.realmeds.tissue.moduller.I_TC_MediaLine.Table_ID)
	...
	*/
	...
	/** Set TC_MediaOutLine.
		@param TC_MediaOutLine_ID TC_MediaOutLine
	*/
	public void setTC_MediaOutLine_ID (int TC_MediaOutLine_ID)
	{
		if (TC_MediaOutLine_ID < 1)
			set_ValueNoCheck (COLUMNNAME_TC_MediaOutLine_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_TC_MediaOutLine_ID, Integer.valueOf(TC_MediaOutLine_ID));
	}

	/** Get TC_MediaOutLine.
		@return TC_MediaOutLine	  */
	public int getTC_MediaOutLine_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TC_MediaOutLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set TC_MediaOutLine_UU.
		@param TC_MediaOutLine_UU TC_MediaOutLine_UU
	*/
	public void setTC_MediaOutLine_UU (String TC_MediaOutLine_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TC_MediaOutLine_UU, TC_MediaOutLine_UU);
	}

	/** Get TC_MediaOutLine_UU.
		@return TC_MediaOutLine_UU	  */
	public String getTC_MediaOutLine_UU()
	{
		return (String)get_Value(COLUMNNAME_TC_MediaOutLine_UU);
	}
	...
	*/
	...
	{
		return (org.realmeds.tissue.moduller.I_TC_out)MTable.get(getCtx(), org.realmeds.tissue.moduller.I_TC_out.Table_ID)
			.getPO(getTC_out_ID(), get_TrxName());
	}
