...
/**
 * Generated Model for TC_ExplantLabel
 * 
 * @author iDempiere (generated)
 * @version Release 10 - $Id$
 */
@org.adempiere.base.Model(table = "TC_ExplantLabel")
public class X_TC_ExplantLabel extends PO implements I_TC_ExplantLabel, I_Persistent {

	/**
	 *
	 */
	private static final long serialVersionUID = 20240422L;

	/** Standard Constructor */
	public X_TC_ExplantLabel(Properties ctx, int TC_ExplantLabel_ID, String trxName) {
		super(ctx, TC_ExplantLabel_ID, trxName);
		/**
		 * if (TC_ExplantLabel_ID == 0) { setTC_ExplantLabel_ID (0); }
		 */
	}

	/** Standard Constructor */
	public X_TC_ExplantLabel(Properties ctx, int TC_ExplantLabel_ID, String trxName, String... virtualColumns) {
		super(ctx, TC_ExplantLabel_ID, trxName, virtualColumns);
		/**
		 * if (TC_ExplantLabel_ID == 0) { setTC_ExplantLabel_ID (0); }
		 */
	}
	...
	/** Load Constructor */
	public X_TC_ExplantLabel(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("X_TC_ExplantLabel[").append(get_ID()).append("]");
		return sb.toString();
	}
	 ...
	 * Set TC_ExplantLabel.
	 * 
	 * @param TC_ExplantLabel_ID TC_ExplantLabel
	 */
	public void setTC_ExplantLabel_ID(int TC_ExplantLabel_ID) {
		if (TC_ExplantLabel_ID < 1)
			set_ValueNoCheck(COLUMNNAME_TC_ExplantLabel_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_TC_ExplantLabel_ID, Integer.valueOf(TC_ExplantLabel_ID));
	}

	/**
	 * Get TC_ExplantLabel.
	 * 
	 * @return TC_ExplantLabel
	 */
	public int getTC_ExplantLabel_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_TC_ExplantLabel_ID);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
	 ...
	 * 
	 * @param TC_ExplantLabel_UU TC_ExplantLabel_UU
	 */
	public void setTC_ExplantLabel_UU(String TC_ExplantLabel_UU) {
		set_ValueNoCheck(COLUMNNAME_TC_ExplantLabel_UU, TC_ExplantLabel_UU);
	}

	/**
	 * Get TC_ExplantLabel_UU.
	 * 
	 * @return TC_ExplantLabel_UU
	 */
	public String getTC_ExplantLabel_UU() {
		return (String) get_Value(COLUMNNAME_TC_ExplantLabel_UU);
	}
