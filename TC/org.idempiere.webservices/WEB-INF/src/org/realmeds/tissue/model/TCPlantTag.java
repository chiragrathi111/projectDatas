...
import org.realmeds.tissue.moduller.X_tc_planttag;

public class TCPlantTag extends X_tc_planttag{
	
	private static final long serialVersionUID = 1L;
	public TCPlantTag(Properties ctx, int TC_PlantTag_ID, String trxName) {
		super(ctx, TC_PlantTag_ID, trxName);
		// TODO Auto-generated constructor stub
	}
	
	public TCPlantTag(Properties ctx, ResultSet rs, String trxName) {
