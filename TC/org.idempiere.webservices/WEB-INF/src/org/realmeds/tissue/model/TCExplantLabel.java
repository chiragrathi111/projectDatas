...
import org.realmeds.tissue.moduller.X_TC_ExplantLabel;

public class TCExplantLabel extends X_TC_ExplantLabel {

	private static final long serialVersionUID = 1L;

	public TCExplantLabel(Properties ctx, int TCExplantLabel_ID, String trxName) {
		super(ctx, TCExplantLabel_ID, trxName);
	}

	public TCExplantLabel(Properties ctx, ResultSet rs, String trxName) {
