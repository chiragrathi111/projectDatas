...
import org.realmeds.tissue.moduller.X_TC_out;

public class TCOut extends X_TC_out implements TC{

	private static final long serialVersionUID = 1L;
	
	public TCOut(Properties ctx, int TC_out_ID, String trxName) {
		super(ctx, TC_out_ID, trxName);
		// TODO Auto-generated constructor stub
	}
	
	public TCOut(Properties ctx, ResultSet rs, String trxName) {
