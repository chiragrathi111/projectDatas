...
public class DPActivities extends DashboardPanel implements EventListener<Event> {
    ...
    private Box createPanel() {
        ...
        btnAlert.setImage(ThemeManager.getThemeResource("images/Assignment16.png"));
    ...
    public void updateUI() {
        ...
        if (noofAlert > 0) {
            btnAlert.setSclass("alert-danger");
        } else {
...
//
//	private Button btnNotice, btnRequest, btnWorkflow, btnUnprocessed, btnAlert;
//
//	private String labelN, labelR, labelW, labelU, labelA;
//	
//	private int noOfNotice, noOfRequest, noOfWorkflow, noOfUnprocessed, noofAlert;
//
//	public DPActivities()
//	{
//		super();
...
//        int AD_Menu_ID = DB.getSQLValue(null, "SELECT AD_Menu_ID FROM AD_Menu WHERE Name = 'Temperature' AND IsSummary = 'N'");
...
//        labelA = Util.cleanAmp(Msg.translate(Env.getCtx(), "alertActivity"));
//        btnAlert.setLabel(labelA + " : 0");
//        btnAlert.setTooltiptext(labelA);
//        btnAlert.setImage(ThemeManager.getThemeResource("images/Assignment16.png"));
//        AD_Menu_ID = DB.getSQLValue(
//        	    null,
//        	    "SELECT AD_Menu_ID FROM AD_Menu WHERE Name = 'Temperature Status' AND IsSummary = 'N'"
//        	);
////        AD_Menu_ID = DB.getSQLValue(null, "SELECT AD_Menu_ID FROM AD_Menu WHERE Name = 'Workflow Activities' AND IsSummary = 'N'");
//        btnAlert.setName(String.valueOf(AD_Menu_ID));
//        btnAlert.addEventListener(Events.ON_CLICK, this);
//
//        return vbox;
//	}
...
//		Event event = new Event(IDesktop.ON_ACTIVITIES_CHANGED_EVENT, null, noOfNotice + noOfRequest+ noOfWorkflow + noOfUnprocessed + noofAlert);
//		queue.publish(event);
//		
//		if (noofAlert > 0) {
//		    btnAlert.setSclass("alert-danger");
