...
//	public static int getOverHeatCount(String period) {
//
//        String sql =
//            "SELECT COUNT(*) " +
...
//    }
    ...
    public static int getOverHeatCountToday() {
...
//			    "AND t.AD_Client_ID = ?";
//
//			int count = DB.getSQLValue(null, sql, Env.getAD_Client_ID(Env.getCtx()));
//			return count;
//	}
//}
