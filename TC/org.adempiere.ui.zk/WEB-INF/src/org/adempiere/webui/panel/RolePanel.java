...
import org.adempiere.webui.component.WmsRole_ConfirmPannel;
...
public class RolePanel extends Window implements EventListener<Event>, Deferrable
{
	...
	protected void createUI() {
        ...
        String applicationTitle = MSysConfig.getValue("ZK_APP_NAME");
        if(applicationTitle == null || applicationTitle.isEmpty())
        	applicationTitle = MSysConfig.getValue(MSysConfig.ZK_BROWSER_TITLE);
        
    	Label label = new Label(Msg.getMsg(Env.getCtx(), "Select your role in "+applicationTitle+""));
    	label.setSclass(ITheme.LOGIN_BOX_ROLE_SELECTION_HEADER_TXT_CLASS);
    	...
    	table.setSclass(ITheme.LOGIN_FIELDS_CONT);
...
//        td.appendChild(image);
    	...
    	td.appendChild(lblClient);
    	
    	
    	tr = new Tr();
        tr.setId("rowclientField");
        table.appendChild(tr);
    	td = new Td();
    	tr.appendChild(td);
    	td.setSclass(ITheme.LOGIN_INPUT_DROPDOWN);
    	div = new Div();
//        div.setSclass("z-icon-user-o role-tenent");
    	div.setSclass("wms-user-icon role-tenent");
        td.appendChild(div);
    	...
    	tr.appendChild(td);
    	td.setSclass(ITheme.LOGIN_LABEL_CLASS);
    	td.appendChild(lblRole);
    	
    	
    	 tr = new Tr();
         tr.setId("rowRoleField");
         table.appendChild(tr);
         td = new Td();
         td.setSclass(ITheme.LOGIN_INPUT_DROPDOWN);
     	tr.appendChild(td);
     	div = new Div();
//        div.setSclass("z-icon-briefcase role");
     	div.setSclass("wms-briefcase-icon role");
        td.appendChild(div);
...
//    	td.appendChild(div);
    	...
    	tr.appendChild(td);
    	td.setSclass(ITheme.LOGIN_LABEL_CLASS);
    	td.appendChild(lblOrganisation);
    	
    	
    	 tr = new Tr();
         tr.setId("rowOrganisationField");
         table.appendChild(tr);
         td = new Td();
         td.setSclass(ITheme.LOGIN_INPUT_DROPDOWN);
     	tr.appendChild(td);
     	div = new Div();
//        div.setSclass("z-icon-users role-users");
     	div.setSclass("wms-outline-users-icon role-users");
        td.appendChild(div);
    	...
    	tr.appendChild(td);
    	td.setSclass(ITheme.LOGIN_LABEL_CLASS);
    	td.appendChild(lblWarehouse);
    	
    	
    	tr = new Tr();
        tr.setId("rowWarehouseField");
        table.appendChild(tr);
        td = new Td();
        td.setSclass(ITheme.LOGIN_INPUT_DROPDOWN);
    	tr.appendChild(td);
    	div = new Div();
//        div.setSclass("z-icon-building-o role-warehouse");
    	div.setSclass("wms-delivery-icon role-warehouse");
        td.appendChild(div);
    	...
    	tr.appendChild(td);
    	td.setSclass(ITheme.LOGIN_LABEL_CLASS);
    	td.appendChild(lblDate);
    	
    	tr = new Tr();
        tr.setId("rowDateField");
        table.appendChild(tr);
        td = new Td();
        td.setSclass(ITheme.LOGIN_INPUT_DROPDOWN);
    	tr.appendChild(td);
    	div = new Div();
//        div.setSclass("z-icon-calendar-o role-calender");
        div.setSclass("wms-calendar-icon role-calender");
        td.appendChild(div);
...
//    	div.setSclass(ITheme.LOGIN_BOX_FOOTER_CLASS);
        WmsRole_ConfirmPannel pnlButtons = new WmsRole_ConfirmPannel(true, false, false, false, false, false, true);
        pnlButtons.addActionListener(this);
        Button okBtn = pnlButtons.getButton(WmsRole_ConfirmPannel.A_OK);
...
//        Button helpButton = pnlButtons.createButton(WmsRole_ConfirmPannel.A_HELP);
...
//		pnlButtons.addComponentsRight(helpButton);
        ...
        LayoutUtils.addSclass(ITheme.Role_BOX_FOOTER, pnlButtons);
        ZKUpdateUtil.setWidth(pnlButtons, null);
        pnlButtons.getButton(WmsRole_ConfirmPannel.A_OK).setSclass(ITheme.LOGIN_BUTTON_CLASS);
        pnlButtons.getButton(WmsRole_ConfirmPannel.A_CANCEL).setSclass(ITheme.LOGIN_BUTTON_CLASS_ROLE_CANCEL);
    ...
    private void initComponents()
    {
        ...
        lblClient.setValue(Msg.getMsg(language,"Tenant"));
        ...
        ZKUpdateUtil.setWidth(lblDate, "100%");
        ...
        ZKUpdateUtil.setWidth(lstRole, "100%");
        ...
        ZKUpdateUtil.setWidth(lstClient, "100%");
        ...
        ZKUpdateUtil.setWidth(lstOrganisation, "100%");
        ...
        ZKUpdateUtil.setWidth(lstWarehouse, "100%");
    ...
    public void onEvent(Event event)
    {
        ...
        if (event.getTarget().getId().equals(WmsRole_ConfirmPannel.A_OK))
        {
            validateRoles(false);
        }
        else if (event.getTarget().getId().equals(WmsRole_ConfirmPannel.A_HELP))
        {
            openLoginHelp();
        }
        else if (event.getTarget().getId().equals(WmsRole_ConfirmPannel.A_CANCEL))
        {
        	if (isChangeRole()) {
