...
public class HeaderPanel extends Panel implements EventListener<Event>
{
    ...
    protected void onCreate()
    {
    	...
    	String logoA = "~./theme/default/images/keralgovtlogo10080.svg";
    	String logoB = "~./theme/default/images/LOGOKDISC10080.svg";
...
//    	image.setSrc(ThemeManager.getSmallLogo());
    	...
    	imageB = (Image) getFellow("logoB");    	
    	imageB.setSrc(logoB);
    	imageB.addEventListener(Events.ON_CLICK, this);
    	imageB.setStyle("cursor: pointer;");
