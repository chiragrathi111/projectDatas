 ...
 * @date July 25, 2007
 **/
public final class WmsLogin_ConfirmPanel extends Div
{
     ...
     */
    public WmsLogin_ConfirmPanel(boolean withCancelButton,
     ...
     *
     */
    public WmsLogin_ConfirmPanel(boolean withCancel)
    {
    ...
    private void init()
    {
        ...
        pnlBtnLeft.setSclass("login-confirm-panel-btn");
