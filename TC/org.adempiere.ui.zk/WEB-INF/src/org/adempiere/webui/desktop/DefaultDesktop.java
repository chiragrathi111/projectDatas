...
{		
	...
	protected Component doCreatePart(Component parent)
    {
        ...
        windowContainer.addWindow(homeTab, Util.cleanAmp(Msg.getMsg(Env.getCtx(), "Dashboard")), false, null);
	...
	public void onEvent(Event event)
    {
        ...
        else if (eventName.equals(ON_ACTIVITIES_CHANGED_EVENT))
        {
        	...
        	String countSting = object.toString();
        	String[] countArray = countSting.split("\\.");
        	Integer count = Integer.parseInt(countArray[0]);
//        	Integer count = (Integer) event.getData();
	...
	public void updateUI() {
		windowContainer.setTabTitle(0, Util.cleanAmp(Msg.getMsg(Env.getCtx(), "Dashboard")) + " (" + noCount + ")", null);
	}
