...
.popup-dialog .z-window-header {
	...
	background-color: #298F60 !important;
	color: #FFF;
    /* font-family: Inter; */
...
.popup-dialog .z-window-header .z-window-icons button{
	border: none;
    outline: none;
    background: none;
    color: white;
...
.popup-dialog .z-window-content .main-parameter-layout .bottom-parameter-layout{
	border: none;
}
...
.popup-dialog .dialog-content span{
	word-break: normal;
	color:#64748B;
    font-size: 12px;
    font-weight: 600;
