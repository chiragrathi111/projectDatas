...
.z-button.temp-alert-red{
    color: red !important;
    font-weight: bold;
}


.dashboard-widget .activities-box .z-window-content .z-grid {
    height: 240px !important;
    display: flex !important;
    flex-direction: column !important;
}

.dashboard-widget .activities-box .z-window-content .z-grid .z-grid-body {
    flex: 1 !important;
...
.dashboard-widget .activities-box .z-window-content .z-grid .z-grid-header {
