...
public class PiUserToken extends X_pi_userToken {
	...
	public static List<PO> getTokensForRole(int clientId, int roleId, Properties ctx, String trxName) {
		List<PO> list = new Query(ctx, Table_Name, "ad_client_ID = ? AND ad_role_ID = ?", trxName)
