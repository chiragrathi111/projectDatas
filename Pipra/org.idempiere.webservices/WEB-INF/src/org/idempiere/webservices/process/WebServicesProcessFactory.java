...
public class WebServicesProcessFactory implements IProcessFactory {
	...
	public ProcessCall newProcessInstance(String className) {
		...
		}else if (className != null &&  className.equalsIgnoreCase("org.pipra.process.GenerateLabelPhysicalInventory")) {
			return new org.pipra.process.GenerateLabelPhysicalInventory();
		}
