...
//                		link.setIconSclass("z-icon-Report");
                		link.setImage(ThemeManager.getThemeResource("images/report.svg"));
                	else
...
//                		link.setIconSclass("z-icon-Process");
                		link.setImage(ThemeManager.getThemeResource("images/process (1).svg"));
                	else
...
//                		link.setIconSclass("z-icon-Workflow");
                		link.setImage(ThemeManager.getThemeResource("images/workflow.svg"));
                	else
...
//                		link.setIconSclass("z-icon-Form");
                		link.setImage(ThemeManager.getThemeResource("images/form (1).svg"));
                	else
...
//                		link.setIconSclass("z-icon-Info");
                		link.setImage(ThemeManager.getThemeResource("images/info (1).svg"));
                	else
...
//                		link.setIconSclass("z-icon-Window");
                		link.setImage(ThemeManager.getThemeResource("images/window-display 1.svg"));
