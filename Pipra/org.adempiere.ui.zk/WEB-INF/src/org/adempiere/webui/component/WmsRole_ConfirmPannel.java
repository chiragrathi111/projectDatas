 ...
 * @date July 25, 2007
 **/
public final class WmsRole_ConfirmPannel extends Div
{
	...
	/** Action String OK.        */
    public static final String A_OK = "Continue";
    /** Action String Cancel.    */
    public static final String A_CANCEL = "Back to Sign In";
     ...
     */
    public WmsRole_ConfirmPannel(boolean withCancelButton,
            ...
            boolean withImage)
    {
        ...
        addComponentsLeft(createButton(A_OK));
     ...
     *
     */
    public WmsRole_ConfirmPannel(boolean withCancel)
    {
...
//    	pnlBtnLeft.setSclass("confirm-panel-left");
        pnlBtnLeft.setSclass("wms-role-confirm-pannel");
        pnlBtnRight = new Hlayout();
        pnlBtnRight.setSclass("wms-role-confirm-pannel");
