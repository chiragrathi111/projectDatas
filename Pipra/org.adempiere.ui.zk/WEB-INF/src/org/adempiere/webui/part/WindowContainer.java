...
import org.adempiere.webui.dashboard.DashboardIcon;
...
public class WindowContainer extends AbstractUIPart implements EventListener<Event>
{
    ...
    protected Component doCreatePart(Component parent)
    {
		...
		btnNotice.setImage(ThemeManager.getThemeResource("images/dashboard-btn-icon.png"));
		btnNotice.setSclass("dashboard-btn");
		btnNotice.addEventListener(Events.ON_CLICK, evt -> setSelectedTab(tabbox.getTabpanel(0).getLinkedTab()));
		DashboardIcon.setBtnNotice(btnNotice);
